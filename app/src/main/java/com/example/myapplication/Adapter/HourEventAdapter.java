...
public class HourEventAdapter extends ArrayAdapter<HourEvent>
{
    public HourEventAdapter(@NonNull Context context, List<HourEvent> hourEvents)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        if (convertView == null)
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.hour_event_cell, parent, false);
